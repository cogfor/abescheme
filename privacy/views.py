...
from charm.adapters import abenc_adapt_hybrid as charm
    ...
    if request.method == 'POST':
        ...
        if p_id:
            ...
            if user.name == name:
                ...
                return render(request, 'index.html', {'msg': 'A user with that ID was not found. Please try again.',
            ...
            if name and view and displen and delete and datause and tracking and gps:
                ...
                return render(request, 'index.html',
                              {'msg': 'There was a mistake in your form entries. Please try again.',
                               'form': form.PolicyForm()})
        ...
        if content:
            ...
            if auth:
                ...
                return render(request, 'policy.html',
                              {'msg': 'The authority has not created any keys for you to encrypt your data!',
                               'id': p_id, 'name': user.name})
            return HttpResponseRedirect('')
        else:
            return render(request, 'policy.html',
                          {'msg': 'You didn\'t enter a status. Please try again.', 'id': p_id, 'name': user.name})
    ...
    if auth:
        ...
        for s in statuses:
            ...
            try:
                ...
                status_pair = (
                "Your status could not be displayed: this service does not support your privacy policy!", s.posted)
